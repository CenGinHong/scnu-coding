...
// LocalFile is the golang structure for table local_file.
...
type CourseAnnouncement struct {
    ...
    AttachmentFileId     int         `orm:"attachment_file_id"             json:"attachmentFileId"`     // 附件url             
    CreatedAt            *gtime.Time `orm:"created_at"                     json:"createdAt"`            // 创建时间            
    UpdatedAt            *gtime.Time `orm:"updated_at"                     json:"updatedAt"`            // 修改时间            
}
...
type Lab struct {
    ...
    AttachmentFileId int         `orm:"attachment_file_id" json:"attachmentFileId"` // 实验附件url       
...
type Course struct {
    ...
    CoverFileId  int         `orm:"cover_file_id"     json:"coverFileId"`  // 封面url的id         
...
type SysUser struct {
    ...
    AvatarFileId int         `orm:"avatar_file_id"  json:"avatarFileId"` // 头像url                
