...
//}
//
//func (s *swarmIDEService) execStopAndRemoveTheiaDocker(req *define.CloseIDEReq) (err error) {
//	// 删除容器
...
//}
//
//func (s *swarmIDEService) execRunTheiaDocker(ctx context.Context, req *define.OpenIDEReq) (port int, err error) {
//	// 得到可用端口
