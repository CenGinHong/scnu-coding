...
type CourseCommentResp struct {
	...
	CourseCommentId int    `orm:"course_comment_id,primary" json:"commentId"` // 主键
	...
	ReplyComments []*CourseCommentResp `orm:"with:pid=course_comment_id" json:"replyComments"`
}

type LabCommentResp struct {
	gmeta.Meta   `orm:"table:lab_comment"`
	LabCommentId int    `orm:"lab_comment_id,primary" json:"commentId"` // 主键
	...
	CreatedAt     *gtime.Time       `orm:"created_at" json:"createdAt"`                  // 创建时间
	UpdatedAt     *gtime.Time       `orm:"updated_at" json:"updatedAt"`                  // 更新时间
	ReplyComments []*LabCommentResp `orm:"with:pid=lab_comment_id" json:"replyComments"` // 子评论
}
